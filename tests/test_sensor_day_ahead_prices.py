...
def test_day_ahead_price_sensor_unavailable_after_three_parse_errors(caplog):
    """Test day ahead price sensor becomes unavailable after 3 consecutive parse errors."""
    entry = _make_mock_entry(features=["day_ahead_prices"])
    sensor = MabwarpDayAheadPriceSensor(entry, DEFAULT_TOPIC_PREFIX)
