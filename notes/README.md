Update notes/README.md for the mABwarp project.
This is an INTERNAL developer documentation file, not the public README.
...
Full API: https://docs.warp-charger.com/de/docs/interfaces/mqtt_http/api_reference/mqtt/
